                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4  p-2 h5">E-Mail ID</div><div class="col-md-8 p-2"><asp:TextBox ID="emailid" runat="server" required="email" TextMode="Email"  CssClass="form-control"></asp:TextBox></div>
                         <div class="col-md-4  p-2 h5">Desgination</div><div class="col-md-8 mt-1 p-2"><asp:DropDownList ID="designation" runat="server" required="designation" CssClass="form-control">
                            <asp:ListItem>Admin</asp:ListItem><asp:ListItem>User</asp:ListItem>
                                                                                                 </asp:DropDownList></div>
